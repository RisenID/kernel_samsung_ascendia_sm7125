...
if [ -e "out/arch/arm64/boot/Image.gz" ]; then
    rm ../../builds/ascendia/sm7125/a52q/aosp_vanilla/dtb
    rm ../../builds/ascendia/sm7125/a52q/aosp_vanilla/kernel

    cp out/arch/arm64/boot/Image ../../builds/ascendia/sm7125/a52q/aosp_vanilla/kernel
    cp out/arch/arm64/boot/dts/qcom/atoll-ab-idp.dtb ../../builds/ascendia/sm7125/a52q/aosp_vanilla/dtb
    ...
    cd ../../builds/ascendia/sm7125/a52q/aosp_vanilla/
    magiskboot_x86 repack boot.img Ascendia_3.2_Vanilla_AOSP_a52q_boot.img

    rm ../../pack_vanilla/ascendia/a52/aosp.img
    cp Ascendia_3.2_Vanilla_AOSP_a52q_boot.img ../../pack_vanilla/ascendia/a52/aosp.img
    ...
    mv Ascendia_3.2_Vanilla_AOSP_a52q_boot.img ../../v3/3.2/
else 
    echo " "
    echo "Build Failed :("
    echo " "
