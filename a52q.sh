...
magiskboot_x86 repack boot.img Ascendia_3.1.2_KSU_OneUI_a52q_boot.img

rm ../../pack_ksu/ascendia/a52/oneui.img
cp Ascendia_3.1.2_KSU_OneUI_a52q_boot.img ../../pack_ksu/ascendia/a52/oneui.img
...
mv Ascendia_3.1.2_KSU_OneUI_a52q_boot.img ../../v3/3.1.2/
