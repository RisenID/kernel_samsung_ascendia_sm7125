...
if [ -e "out/arch/arm64/boot/Image.gz" ]; then
    rm ../../builds/ascendia/sm7125/a52q/oneui_ksu/dtb
    rm ../../builds/ascendia/sm7125/a52q/oneui_ksu/kernel

    cp out/arch/arm64/boot/Image ../../builds/ascendia/sm7125/a52q/oneui_ksu/kernel
    cp out/arch/arm64/boot/dts/qcom/atoll-ab-idp.dtb ../../builds/ascendia/sm7125/a52q/oneui_ksu/dtb
    ...
    cd ../../builds/ascendia/sm7125/a52q/oneui_ksu/
    magiskboot_x86 repack boot.img Ascendia_3.2_KSU_OneUI_a52q_boot.img

    rm ../../pack_ksu/ascendia/a52/oneui.img
    cp Ascendia_3.2_KSU_OneUI_a52q_boot.img ../../pack_ksu/ascendia/a52/oneui.img
    ...
    mv Ascendia_3.2_KSU_OneUI_a52q_boot.img ../../v3/3.2/
